...
return [
    ...
    */
    ...
    'confirmed' => 'El :attribute de la confirmación no coincide.',
    ...
    'size' => [
        'numeric' => 'El/la :attribute must be :size.',
        'file' => 'El/la :attribute must be :size kilobytes.',
        'string' => 'El/la :attribute debe ser :size caracteres.',
        'array' => 'El/la :attribute must contain :size items.',
    ],
    'starts_with' => 'El/la :attribute must start with one of the following: :values.',
    'string' => 'El/la :attribute must be a string.',
    'timezone' => 'El/la :attribute debe ser una zona válida.',
    'unique' => 'El/la :attribute ya se ha registrado.',
    'uploaded' => 'El/la :attribute no se pudo cargar',
    'url' => 'El/la :attribute el formato no es válido.',
