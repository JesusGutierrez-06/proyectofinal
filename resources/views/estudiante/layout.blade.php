    ...
    <header class="full-reset header">
        ...
        <nav class="full-reset navigation">
            <ul class="full-reset list-unstyled">
                ...
                <li><a href="{{ route('ensec.about') }}">Institución</a></li>
                <li><a href="{{ route('ensec.admision') }}">Admisión</a></li>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        ...
                        <ul class="list-unstyled full-reset">
                            ...
                            <li><a href="#"><i class="fa fa-graduation-cap"></i>&nbsp; Plataforma (VIRTUAL)</a></li>
                            <li><a href="{{ route('ofertas.index') }}"><i class="fa fa-search"></i>&nbsp; Buscar Ofertas
                                    Laborales</a></li>
                            <li><a href="{{ route('postular.index') }}"> <i class="fa fa-folder"></i>&nbsp; Mis Ofertas
                                    Postuladas</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        ...
                        <ul class="list-unstyled full-reset">
                            <li><a href="{{ route('estudiante.show', ':' . Auth::user()->id) }}"><i
                                        class="fa fa-folder-open"></i>&nbsp; Datos Generales</a></li>
                            <li><a href="{{ route('estudiante.edit', ':' . Auth::user()->id) }}"><i
                                        class="fa fa-list-alt"></i>&nbsp; Actualizar datos Personales</a></li>
                            <li><a href="{{ route('estudios.index') }}"><i class="fa fa-newspaper-o"></i>&nbsp;
                                    Información Académica </a></li>
                            <li><a href="{{ route('exp_laboral.index') }}"><i class="fa fa-file"></i>&nbsp; Experiencia
                                    laboral &<br><i class="fa fa-language"></i>&nbsp; Idiomas</a></li>
                            <li></li>
         ...
         this.closest('form').submit();">
                            ...
                            {{-- <li>
                                <form action="{{ route('admin.destroy', Auth::user()->id) }}" class="formulario"
                                    ...
                                    <button class="btn-delete" onclick="confirmar();"><i
