...
<br />
Edad: <?php  $edad=substr($data['estudiante']->fechanac,0,4); $edad = 2020-$edad; echo $edad;?> años
</p>
<p class="bio_right">

{{$data['estudiante']->direccion}} <br />
{{$data['departamento']->nombre}}-{{$data['provincia']->nombre}}
</p>
...
<div class="job">
   <p class="date">
        <?php
             if ($estudios->fechafin != null) {
            echo substr($estudios->fechafin,0,4);
        } else {
            echo 'Cursando';
        }
    ?>
