...
>>>>>>> a0fafc9f8242f00d39a4ebffc22d8efb2b11d03b
        $data = DB::table('estudiante')
            ...
            ->select(
                ...
                'tipo_sangre.nombre as tipo_sangre',
...
>>>>>>> a0fafc9f8242f00d39a4ebffc22d8efb2b11d03b
    ...
    public function destroy(Request $request, $estudiante)
    {
        $estudiante = explode(':', $estudiante);
        if (count($estudiante) > 1) {
            $estudiante = Estudiante::Where('users_id', '=', $estudiante[1])->first();
        ...
        // dd($empresa);
        $estudiante->save();
        return redirect()->route('estudiante.index')->with('eliminar', 'ok');
    }
